...
{
    public class DispensingX1ResultClass : GeoResultClass
    {
        ...
        public DispensingX1ResultClass(Result_EA resultea, VersionEnum version, OptionEnum option, MachineCollectionClass machinecollection)
        {
            myResultEA = resultea;
            VERSION = version;
            OPTION = option;
            ...
            MACHINE = (DispensingX1MachineClass)machinecollection.MACHINE;
