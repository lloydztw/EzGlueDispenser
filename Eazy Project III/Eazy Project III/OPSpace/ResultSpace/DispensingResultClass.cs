...
{
    public class DispensingResultClass : GeoResultClass
    {
        ...
        public DispensingResultClass(Result_EA resultea, VersionEnum version, OptionEnum option, MachineCollectionClass machinecollection)
        {
            myResultEA = resultea;
            VERSION = version;
            OPTION = option;
            ...
            MACHINE = (DispensingMachineClass)machinecollection.MACHINE;
