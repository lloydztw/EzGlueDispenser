...
{
    public class DispensingX4MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public DispensingX4IOClass PLCIO;
        public EventClass EVENT;

        public DispensingX4MachineClass(Machine_EA machineea, string opstr, string workpath, bool isnouseplc)
        {
