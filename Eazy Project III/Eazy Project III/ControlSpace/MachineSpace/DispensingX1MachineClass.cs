...
{
    public class DispensingX1MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public DispensingX1IOClass PLCIO;
        public EventClass EVENT;

        public DispensingX1MachineClass(Machine_EA machineea, string opstr, string workpath, bool isnouseplc)
        {
