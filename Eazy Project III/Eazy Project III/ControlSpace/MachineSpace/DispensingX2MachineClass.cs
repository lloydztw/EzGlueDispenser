...
{
    public class DispensingX2MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public DispensingX2IOClass PLCIO;
        public EventClass EVENT;

        public DispensingX2MachineClass(Machine_EA machineea, string opstr, string workpath, bool isnouseplc)
        {
