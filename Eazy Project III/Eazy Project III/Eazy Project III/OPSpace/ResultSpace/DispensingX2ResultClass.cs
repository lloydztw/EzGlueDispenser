...
{
    public class DispensingX2ResultClass : GeoResultClass
    {
        public string BARCODE = "";
        public string VER = "";

        DispensingX2MachineClass MACHINE;

        JzToolsClass JzTools = new JzToolsClass();
        SoundPlayer PlayerPass = new SoundPlayer();
        SoundPlayer PlayerFail = new SoundPlayer();

        public DispensingX2ResultClass(Result_EA resultea, VersionEnum version, OptionEnum option, MachineCollectionClass machinecollection)
        {
            myResultEA = resultea;
            VERSION = version;
            OPTION = option;
            ...
            MACHINE = (DispensingX2MachineClass)machinecollection.MACHINE;
